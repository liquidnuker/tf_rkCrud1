...
function updateObject(oldObject, newValues) {
  ...
  return (0, _assign2.default)({}, oldObject, newValues);
}

function updateItemInArray(array, itemId, updateItemCallback) {
  var updatedItems = array.map(function (i) {
    if (i.id !== itemId) {
    ...
    var updatedItem = updateItemCallback(i);
    return updatedItem;
  });
...
var _RkCrud = __webpack_require__(48);

var _RkCrud2 = _interopRequireDefault(_RkCrud);
...
function Home(props) {
  return React.createElement(
    ...
    React.createElement(
      "div",
      { className: "col-sm-9" },
      React.createElement(_RkCrud2.default, null)
    )
  );
}
...
var AddTodoToggle = function (_React$Component) {
  (0, _inherits3.default)(AddTodoToggle, _React$Component);

  function AddTodoToggle(props) {
    (0, _classCallCheck3.default)(this, AddTodoToggle);

    var _this = (0, _possibleConstructorReturn3.default)(this, (AddTodoToggle.__proto__ || (0, _getPrototypeOf2.default)(AddTodoToggle)).call(this, props));
  ...
  (0, _createClass3.default)(AddTodoToggle, [{
    key: 'toggleAddTodo',
    value: function toggleAddTodo() {
      var _this2 = this;

      this.setState(function (prevState) {
        return {
          addTodo: !_this2.state.addTodo
        };
      });
    }
  }, {
  ...
  return AddTodoToggle;
}(React.Component);

var TodoDisplay = function (_React$Component2) {
  (0, _inherits3.default)(TodoDisplay, _React$Component2);

  function TodoDisplay(props) {
    (0, _classCallCheck3.default)(this, TodoDisplay);

    var _this4 = (0, _possibleConstructorReturn3.default)(this, (TodoDisplay.__proto__ || (0, _getPrototypeOf2.default)(TodoDisplay)).call(this, props));
  ...
  (0, _createClass3.default)(TodoDisplay, [{
    key: 'render',
    value: function render() {
      return React.createElement(
        'div',
        null,
        this.props.pr_todoList.map(function (i) {
          return React.createElement(
            'p',
            null,
            i.todo
...
var RkCrud1 = function (_React$Component3) {
  (0, _inherits3.default)(RkCrud1, _React$Component3);

  function RkCrud1(props) {
    (0, _classCallCheck3.default)(this, RkCrud1);

    var _this5 = (0, _possibleConstructorReturn3.default)(this, (RkCrud1.__proto__ || (0, _getPrototypeOf2.default)(RkCrud1)).call(this, props));
  ...
  (0, _createClass3.default)(RkCrud1, [{
    key: 'render',
    value: function render() {
      return React.createElement(
        'div',
        null,
        React.createElement(TodoDisplay, {
          pr_todoList: this.state.todos }),
        React.createElement(AddTodoToggle, null)
      );
    }
  }]);
  return RkCrud1;
